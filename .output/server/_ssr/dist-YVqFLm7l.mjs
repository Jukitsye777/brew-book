import { A as noop, C as isNull, D as isString, T as isObject, b as isDate, g as isBigInt, i as IdentifierNode, k as isUndefined, l as RawNode, m as freeze, n as CreateViewNode, o as ON_COMMIT_ACTIONS, r as DefaultQueryCompiler, t as CreateTableNode, u as SchemableIdentifierNode, v as isBoolean, w as isNumber, x as isFunction, y as isBuffer } from "./default-query-compiler-_xHHMmaY.mjs";
import { A as randomString, C as parseExpression, D as parseValueBinaryOperationOrExpression, E as parseTable, M as waitOrAbort, O as printBackgroundFail, S as parseDataTypeExpression, T as parseStringReference, _ as createFunctionModule, a as Deferred, b as logOnce, c as OperationNodeTransformer, d as QueryNode, f as SelectAllNode, g as WithSchemaPlugin, h as ValueNode, i as CompiledQuery, j as sql, k as provideControlledConnection, l as QueryCreator, m as ValueListNode, n as CaseNode, o as DynamicReferenceBuilder, p as SelectQueryNode, r as ColumnNode, s as DynamicTableBuilder, t as CaseBuilder, u as QueryExecutorBase, v as createQueryId, w as parseOrderedColumnName, x as parseColumnName, y as isOperationNodeSource } from "./compiled-query-31X3wtWC.mjs";
import { n as SqliteAdapter, r as SqliteQueryCompiler, t as DialectAdapterBase } from "./sqlite-adapter-Do8zBjv9.mjs";
import { a as createAdapterFactory, g as logger } from "./factory-DSqD_Zwm.mjs";
import { t as capitalizeFirstLetter } from "./string-BjC7GJE-.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/dist-YVqFLm7l.js
/**
* @internal
*/
...
var createKyselyAdapter = async (config) => {
	...
	if ("fileControl" in db) {
		const { BunSqliteDialect } = await import("./bun-sqlite-dialect-BW9W1_Ps-ENw8UXqv.mjs");
	...
	if ("createSession" in db) {
		...
		if (DatabaseSync && db instanceof DatabaseSync) {
			const { NodeSqliteDialect } = await import("./node-sqlite-dialect-B89FMdGY.mjs");
			dialect = new NodeSqliteDialect({ database: db });
		}
	}
	if ("batch" in db && "exec" in db && "prepare" in db) {
		const { D1SqliteDialect } = await import("./d1-sqlite-dialect-BLC8LXE6-BINf2sjM.mjs");

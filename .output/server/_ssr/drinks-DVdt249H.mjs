import { r as BetterAuthError, s as env } from "./env-impl-BHOrMFz1.mjs";
//#region node_modules/.nitro/vite/services/ssr/assets/drinks-DVdt249H.js
/**
...
function getDrinkDay(date) {
	return request(`/api/drinks?date=${encodeURIComponent(date)}`);
}
function saveResponse(input) {
	return request("/api/drinks", {
		method: "PUT",
		body: JSON.stringify({
			type: "response",
			...input
...
//#endregion
export { saveDefault as _, drinks as a, getHost as c, isDynamicBaseURLConfig as d, isRequestLike as f, resolveBaseURL as g, periods as h, defu as i, getOrigin as l, normalizePathname as m, createDefu as n, getBaseURL as o, isSafeUrlScheme as p, createFetch as r, getDrinkDay as s, betterFetch as t, getProtocol as u, saveResponse as v, wildcardMatch as y };

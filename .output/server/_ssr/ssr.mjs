...
//#region node_modules/.nitro/vite/services/ssr/assets/server-DcnQrAmM.js
...
async function getStartManifest(matchedRoutes) {
	const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-Cl1om6Qe.mjs");
...
async function loadEntries() {
	const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
		import("./router-Cj6GXOQ0.mjs"),
		import("./start-BbnXIfKN.mjs"),
...
//#endregion
export { createServerEntry, server_default as default, requestHandler as n, server_exports as r, getResponse as t };
